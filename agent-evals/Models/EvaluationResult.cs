...
)
{
    ...
    /// </summary>
    public static EvaluationResult Numeric(string name, double value, string? comment = null)
        => new(name, NumericValue: value, Comment: comment);

    /// <summary>
    /// Creates a categorical evaluation result.
    /// </summary>
    public static EvaluationResult Categorical(string name, string value, string? comment = null)
        => new(name, StringValue: value, Comment: comment);

    /// <summary>
    /// Creates a boolean evaluation result.
    /// </summary>
    public static EvaluationResult Boolean(string name, bool value, string? comment = null)
        => new(name, BooleanValue: value, Comment: comment);
}
